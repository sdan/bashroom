/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 1b0ba647b9e762fe3604f8986c8a20b1)
...
interface __BaseEnv_CloudflareEnv {
	...
	BASHROOM_ADMIN_TOKEN: string;
	REGISTRY: DurableObjectNamespace<import("./src/index").Registry>;
	ACCOUNTS: DurableObjectNamespace<import("./src/index").AccountDO>;
	SANDBOXES: DurableObjectNamespace<import("./src/index").Sandbox>;
	ROOM_HUBS: DurableObjectNamespace<import("./src/index").RoomHub>;
	DOCUMENT_COLLABS: DurableObjectNamespace<import("./src/index").DocumentCollab>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Registry" | "Sandbox" | "AccountDO" | "RoomHub" | "DocumentCollab";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ROOM_TEXT_MODE" | "SANDBOX_TRANSPORT" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "BASHROOM_PUBLIC_URL" | "BASHROOM_ADMIN_TOKEN">> {}
}
declare module "*.md" {
	const value: string;
